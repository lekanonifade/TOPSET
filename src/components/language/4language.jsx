    ...
    return (
        <div className='flex flex-col gap-10 lg:px-16 md:px-8 px-5 bg-[#F8F5FC] py-16 pb-24'>
            ...
            <div className='flex flex-col gap-5 md:flex-row md:gap-10'>
                <div className='flex flex-col gap-10 py-5 md:w-[30%] self-center md:self-auto' data-aos="fade-right">
                    <img src="../images/language-benefits.svg" alt="" className='w-72 md:w-full' />
                </div>
                <div className='flex md:flex-col flex-col gap-10 md:w-[70%] text-center md:text-left' data-aos="fade-up" data-aos-delay="1000">
                    <p className='text-justify lg:px-32 md:px-24 px-16 lg:text-lg md:text-base text-sm'>
